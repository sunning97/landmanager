        ...
        <div class="row row-offcanvas row-offcanvas-right">
            ...
            <div class="content-wrapper">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <h6 class="card-title">Nhập dữ liệu danh sách muốn merge</h6>
                            <div class="col-12" id="app">
                                <form id="edit_user" action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="input_file" class="col-form-label">Merge theo</label>
